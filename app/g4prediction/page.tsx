  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        }) => total_variants = row.num_transcript_variants > total_variants ? row.num_transcript_variants : total_variants
        )
                        ...
                        (row: {
                          ...
                          return (
                            <Tr>
                              <Td>{row.start}</Td>
                              <Td>{row.len}</Td>
                              <Td>{(row.numgs  + "G").replace("GG", "G")}</Td>
                              <Td>{row.score}</Td>
                              <Td>
                          ...
                          (row: {
                            ...
                            return (
                              <Tr>
                                <Td>{row.start}</Td>
                                <Td>{row.len}</Td>
                                <Td>{((row.numgs  + "G").replace("GG", "G")).replace("GG", "G")}</Td>
                                <Td>{row.score}</Td>
                                <Td>
                                  <Stack direction="row" spacing={0.5}>
                                    {row.sequence.split("").map((char) =>
